...
SERVER_NAME = "SERVER_2 (Secondary Backend Node)"
PORT = 5003
request_count = 0
...
def home():
    ...
    <div style="font-family: Arial, sans-serif; text-align: center; padding: 50px; background-color: #0f172a; color: #fff; min-height: 80vh;">
        ...
        <h2 style="color: #a855f7;">Served by: {SERVER_NAME}</h2>
        <p style="font-size: 18px; color: #94a3b8;">Port: {PORT}</p>
        <hr style="border-color: #334155; width: 60%; margin: 20px auto;">
        <p style="font-size: 20px;">Total Handled Requests by Server 2: <strong style="color: #facc15;">{request_count}</strong></p>
